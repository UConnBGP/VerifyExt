...
The verifier class generates statistics for the verification of a singel Autonomous System.
"""
...
class Verifier:
    ...
    def __init__(self, ext_n = r"verify_data", mrt_n = r"verify_ctrl_distinct"):
        # Set dynamic SQL table names
        self.ext_table = ext_n
        self.mrt_table = mrt_n
